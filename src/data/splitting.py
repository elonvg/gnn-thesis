...
def _butina_split_indices(
    ...
    split_sizes = _resolve_split_sizes(len(features), split_fractions) # Fractions -> integers

    train_indices, val_indices, test_indices = [], [], []
    train_cutoff = split_sizes["train"]
    val_cutoff = split_sizes["train"] + split_sizes["val"]
    ...
    for cluster_set in cluster_sets:
        ...
        elif len(train_indices) + len(val_indices) + len(cluster_set) <= val_cutoff:
...
def butina_split_from_csv(
    ...
    train_indices, val_indices, test_indices = _butina_split_indices(
        features,
        split_fractions,
        cluster_csv_path,
        cluster_col,
