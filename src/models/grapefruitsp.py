...
class GrapefruitSP(nn.Module):
    ...
    def forward(self, data):
        x, edge_index, virtual_edge_index, edge_attr, virtual_edge_attr, fragment_id, batch = data.x, data.edge_index, data.virtual_edge_index, data.edge_attr, data.virtual_edge_attr, data.fragment_id, data.batch
